...
{
    internal static class AssistRequestHelper
    {
        public static PaymentSystemsConstants.PaymentStatus CheckPaymentStatus(string orderNumber, AssistPaymentsOptions options)
        {
        ...
        public static string AuthorizeRequest(string orderNumber, decimal orderAmount, string orderComment, string firstName, string lastName, string email, string mobilePhone, string returnUrl, AssistPaymentsOptions options)
        {
            using (var client = new HttpClient())
            {
                var requestMessage = new HttpRequestMessage
